...
export default function Lander() {
  ...
  return (
    <div className="bg-black">
      <header className="absolute inset-x-0 top-00 z-50">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <a
                    href="#"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-400 hover:bg-gray-50"
                  >
                    Log in
                  </a>
                </div>
